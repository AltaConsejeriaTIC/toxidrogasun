...
class JConfig {
	...
	public $sitename = 'Toxidrogas UN';				// Name of Joomla site
	...
	public $password = '43b5f06de2';						// DB password
	public $db = 'bitnami_joomla';							// DB database name
	public $dbprefix = 'jos_';					// Do not change unless you need to!

	/* Server Settings */
	public $secret = '35ac098c0c478bb6a949cd377f07d92b'; 		// Change this to something more secure
	public $gzip = '0';
